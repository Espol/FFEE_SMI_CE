 ...
 * generated in the ec.gob.sri.comprobantes.ws.rec package. 
...
public class ObjectFactory {
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: ec.gob.sri.comprobantes.ws.rec
     * 
     */
