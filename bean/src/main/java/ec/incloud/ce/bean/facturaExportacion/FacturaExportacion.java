...
public class FacturaExportacion {
    ...
    private InfoFacturaExportacion infoFactura;
    private List<FacturaExportacionDetalle> detalles;
    ...
    public InfoFacturaExportacion getInfoFactura() {
        return infoFactura;
    }

    public void setInfoFactura(InfoFacturaExportacion infoFactura) {
        this.infoFactura = infoFactura;
    }

    public List<FacturaExportacionDetalle> getDetalles() {
        return detalles;
    }

    public void setDetalles(List<FacturaExportacionDetalle> detalles) {
    ...
    public String getIVA_12() {
        ...
        for (FacturaExportacionDetalle facturaDetalle : this.getDetalles()) {
    ...
    public String getPROPINA() {
        return this.getInfoFactura().getPropina();
    }

    public String getIMPORTE_TOTAL() {
        return this.getInfoFactura().getImporteTotal();
    }
}
