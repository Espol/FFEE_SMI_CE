 ...
 */
class FacturaReembolsoEmision implements Emision<FacturaReembolso> {

    private static Emision<FacturaReembolso> instance = null;
    private FacturaReembolso factura;
    ...
    private FacturaReembolsoEmision() {
    }

    static Emision<FacturaReembolso> create() {
        synchronized (FacturaReembolsoEmision.class) {
            if (instance == null) {
                instance = new FacturaReembolsoEmision();
            }
            return instance;
        }
    }
...
//            String montoTotal
    ...
    private void validarXML() throws ValidacionException {
        try{
            ValidacionFactory.createValidacionFacturaReembolsoServices().validar(this.factura);
        }catch (ValidacionException ex){
    ...
    private void generarXML() throws XmlException {
        ...
        XmlFactory.getFacturaReembolsoXmlServices().generarXml(this.factura, this.pathAbsoluteXML);
        ...
        XmlFactory.getFacturaReembolsoXmlServices().generarXml(this.factura, this.pathBackupXML);
    }
